...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('Age_general', models.CharField(blank=True, choices=[('ALL', 'All'), ('AD', 'Adults'), ('C', 'Children'), ('AL', 'Adolescents'), ('EA', 'Elderly Adults'), ('I', 'Infant'), ('M', 'Mix')], max_length=5, verbose_name='Age Category')),
                ...
                ('Notes', models.TextField(blank=True, default='')),
                ('Study', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='database.studies')),
            ],
            options={
